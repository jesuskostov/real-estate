<template>
  <div>
    <div id="menu" class="flex h-16 justify-around fixed bg-white w-11/12 z-20 bottom-10 left-1/2 transform -translate-x-1/2 rounded-3xl py-1">
      <button :class="{'active': page === 'search-all'}" @click="goTo('SearchAll', 'search-all')">
          <svg xmlns="http://www.w3.org/2000/svg" width="28.182" height="28.271" viewBox="0 0 21.182 20.271">
          <g id="Group_49" data-name="Group 49" transform="translate(-2942 -66.863)">
              <path id="Rectangle_23" data-name="Rectangle 23" d="M0,0H2.683a0,0,0,0,1,0,0V7.858A1.342,1.342,0,0,1,1.342,9.2h0A1.342,1.342,0,0,1,0,7.858V0A0,0,0,0,1,0,0Z" transform="translate(2954.55 80.979) rotate(-48)"/>
              <circle id="Ellipse_10" data-name="Ellipse 10" cx="8.142" cy="8.142" r="8.142" transform="translate(2942 66.863)"/>
          </g>
          </svg>
      </button>
      <button :class="{'active': page === 'AddHouse' || page === 'add-house'}" class="mid" @click="goTo('AddHouse', 'add-house')">
          <svg xmlns="http://www.w3.org/2000/svg" width="28.598" height="28.022" viewBox="0 0 23.598 22.022">
      ...
      <button :class="{'active': page === 'Home' || page === ''}" @click="goTo('Home', '')">
          <svg id="_352536_map_icon" data-name="352536_map_icon" xmlns="http://www.w3.org/2000/svg" width="32.245" height="32.245" viewBox="0 0 26.245 26.245">
